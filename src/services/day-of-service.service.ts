...
// Utilities
import { getAutoGenerateDate, getTomorrow } from '@src/utils/date'
import {
  checkTurnOfServiceStatus,
  getListTurnOfServices,
  updateTurnOfServices,
} from '@src/utils/turn-of-service'
import { ClientSession, PipelineStage, Types } from 'mongoose'
import { getDateList } from '@src/utils/date'
import SubFieldModel from '@src/models/subfield.model'
import { wait } from '@src/utils/common'

/**
 * Get Day of service by Id and including list turn of services in time range provided
 * @param id
 * @param from time step
 * @param to time step
 * @returns a Day of service
 */
...
/**
 * Get Day of service by field Id and including list turn of services in time range provided
 * @param id field Id
 * @param from time step
 * @param to time step
 * @returns a Day of services
 */
...
/**
 *  Get Day of services by subfield Id
 * @param id subfield Id
 * @param date to search for
 * @returns a day of the services
 */
...
export async function getManyAvailable(
   ...
   */
  let fieldIds: unknown[] | null = null
  if (fieldId) {
    fieldIds = []
    fieldIds.push(new Types.ObjectId(fieldId))
  }
...
/**
 * Generate on create a new Football Subfield
 * @param fieldId
 * @param subfieldId
 * @param defaultPrice
 * @param fieldOpenTime
 * @param fieldCloseTime
 * @param session
 */
...
/**
 * Auto generate Many Days of Services
 */
...
/**
 * Check if `DayOfServices` in Database matches with these Parameters
 * @param date
 * @param subfieldId
 * @param from
 * @param to
...
/**
 * Add booking Id into `turns of service`  inf time range and change `status`
 * @param bookingId
 * @param subfieldId
 * @param date
 * @param from
